package com.jsalazar.platzigram.adapter;
...
import com.jsalazar.platzigram.view.PictureDetailActivity;
                ...
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
                    ...
                    activity.startActivity(intent, ActivityOptionsCompat.
                            makeSceneTransitionAnimation(activity, view, activity.
                                    getString(R.string.transitionname_cardpicture)).toBundle());
